# Module 4 - User Personalization and OneDrive for Business Operations Using CAM Patterns #
...
3. Move to the **O3658-4 Demos/UserProfilePropertySync** folder and open the existing solution named **UserProfilePropertySync.sln**.
...
3.	Move to **O3658-4 Demos/OneDriveCustomizer** folder and open the existing solution named **OneDriveCustomizer.sln**.
