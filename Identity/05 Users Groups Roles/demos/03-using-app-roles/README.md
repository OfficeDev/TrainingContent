# Demo: Utilize app roles in custom web apps

This completed project is the result of the lab exercise **Utilize app roles in custom web apps** that is referenced in the [README](../../) in this repo.
