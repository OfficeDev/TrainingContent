# Demo: Utilize app roles in custom web apps and APIs

This completed project is the result of the lab exercise **Utilize app roles in custom web apps and APIs** that is referenced in the [README](../../README.md) in this repo.
