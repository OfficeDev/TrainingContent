# Demo: Utilize security groups in custom web apps

This completed project is the result of the lab exercise **Utilize security groups in custom web apps** that is referenced in the [README](../../) in this repo.
