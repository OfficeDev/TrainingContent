Calling Microsoft Graph API for Mail with iOS
==============================================
...
02. Open the **.xcworkspace** file in the **[\\\O3654\O3654-5 iOS\04 O365 Exc SDK\src\O365-Exchange-App](src/O365-Exchange-App)** folder
