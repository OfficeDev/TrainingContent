...
Strings.OfficeOM.ConnectionFailureWithDetails = "فشل الطلب برمز الحالة {0} ورمز الخطأ {1} وظهرت رسالة الخطأ التالية: {2}";
...
Strings.OfficeOM.L_ValueNotLoaded = 'لم يتم تحميل قيمة كائن النتيجة بعد. قم باستدعاء "context.sync()" في سياق الطلب المقترن قبل قراءة خاصية القيمة.';
