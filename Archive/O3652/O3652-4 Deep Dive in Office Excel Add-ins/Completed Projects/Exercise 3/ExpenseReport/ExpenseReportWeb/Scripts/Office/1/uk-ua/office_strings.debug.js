...
Strings.OfficeOM.ConnectionFailureWithDetails = "Не вдалося виконати запит. Код стану: {0}; код помилки: {1}; повідомлення про помилку: {2}. ";
Strings.OfficeOM.L_MissingParameter = "Відсутній параметр";
Strings.OfficeOM.L_NewWindowCrossZone = 'Параметри безпеки вашого браузера забороняють створення діалогового вікна. Скористайтеся іншим браузером, або {0} так, щоб домен "{1}" і домен, який відображається в адресному рядку, знаходилися в одній зоні безпеки.';
...
Strings.OfficeOM.L_NewWindowCrossZoneErrorString = "Обмеження браузера забороняють створення діалогового вікна. Домен діалогового вікна та домен хоста надбудови не збігаються.";
