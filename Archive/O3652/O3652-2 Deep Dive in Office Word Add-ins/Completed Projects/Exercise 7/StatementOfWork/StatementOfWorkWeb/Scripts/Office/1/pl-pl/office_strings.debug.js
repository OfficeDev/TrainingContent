...
Strings.OfficeOM.ConnectionFailureWithDetails = "Żądanie zakończyło się niepowodzeniem z kodem stanu {0}, kodem błędu {1} i następującym komunikatem o błędzie: {2}";
