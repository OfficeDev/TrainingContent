   ...
   $.widget("ui.weekCalendar", {
      ...
      _renderCalendar : function() {
         ...
         if (options.buttons) {
            calendarNavHtml = "<div class=\"wc-nav\">\
                    ...
                    <div class=\"navgroupname\">Date Controls</div>\
                    </div>";

            $(calendarNavHtml).appendTo('#buttoncontainer');

            $('#buttoncontainer').find(".wc-nav .wc-today").click(function() {
               self.element.weekCalendar("today");
               return false;
            });

            $('#buttoncontainer').find(".wc-nav .wc-prev").click(function () {
               self.element.weekCalendar("prevWeek");
               return false;
            });

            $('#buttoncontainer').find(".wc-nav .wc-next").click(function () {
      ...
      _updateDayColumnHeader : function ($weekDayColumns) {
         ...
         self.element.find(".wc-header td.wc-day-column-header").each(function(i, val) {
             var users = ["All","Niall","David","Phil"];
            var dayName = users[i];
            if (dayName == "All")
            {
                $(".wc-time-column-header").html(self._formatDate(currentDay, options.dateFormat));
            }
