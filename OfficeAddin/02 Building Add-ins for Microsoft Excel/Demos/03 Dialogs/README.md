# Demo: Work with dialogs in Excel

This completed project is the result of the lab exercise **Work with dialogs in Excel** that is referenced in the [README](../../) in this repo.
