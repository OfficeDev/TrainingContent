# Excel Portfolio - React

To run this demo, open a terminal/command prompt, and change directories to this location, and run the following commands
...
Then follow one of these methods to sideload and test the Office Add-in.
