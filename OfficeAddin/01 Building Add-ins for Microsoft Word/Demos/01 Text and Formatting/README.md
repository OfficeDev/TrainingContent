# Demo: Insert and format a range of text

This completed project is the result of the lab exercise **Insert and format a range of text** that is referenced in the [README](../../) in this repo.
