...
3.  Move to the __Demos/PersonalizedSearchResults__ folder and open the existing solution named __PersonalizedSearchResults.sln__.
...
1.  Create a display template.
    * Open __DefaultGlossary_Orig.html__ with __Microsoft Visual Studio__. This file can be found in the __Demos/SearchUICustomizations__ folder.
