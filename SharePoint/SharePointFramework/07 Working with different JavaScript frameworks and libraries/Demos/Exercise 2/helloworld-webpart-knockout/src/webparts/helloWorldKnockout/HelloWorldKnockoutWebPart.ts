...
import * as strings from 'helloWorldKnockoutStrings';
import HelloWorldKnockoutViewModel, { IHelloWorldKnockoutBindingContext } from './HelloWorldKnockoutViewModel';
import { IHelloWorldKnockoutWebPartProps } from './IHelloWorldKnockoutWebPartProps';

let _instance: number = 0;

export default class HelloWorldKnockoutWebPart extends BaseClientSideWebPart<IHelloWorldKnockoutWebPartProps> {
  private _id: number;
