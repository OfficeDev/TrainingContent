...
namespace ExchangeClientDemo {
  ...
  public class ContactFactory {
    ...
    public static MyContact GetRandomContact() {
      ...
      return new MyContact { GivenName = FirstName, Surname = LastName, CompanyName = Company, BusinessPhone1 = WorkPhoneNumber, HomePhone1 = HomePhoneNumber, EmailAddress1 = Email};
    }
