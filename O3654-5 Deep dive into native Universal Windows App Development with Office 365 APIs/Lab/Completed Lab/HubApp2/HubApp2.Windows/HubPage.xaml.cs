...
namespace HubApp2
{
	...
	public sealed partial class HubPage : Page
	{
		...
		private async void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
		{
			...
			this.DefaultViewModel["CalendarItems"] = groups.First(g => g.UniqueId.Equals("calendar"));
			this.defaultViewModel["ContactItems"] =  groups.First(g => g.UniqueId.Equals("contacts"));
			this.defaultViewModel["MailItems"] = groups.First(g => g.UniqueId.Equals("mail"));
			this.defaultViewModel["FileItems"] = groups.First(g => g.UniqueId.Equals("files"));
		}
