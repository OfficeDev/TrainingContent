...
If you need to dynamically update the page title based on the myteamsapp, you can use the browser [`document.title`](https://developer.mozilla.org/en-US/docs/Web/API/Document/title) API. For more complex scenarios when you want to change the title from React components, you can use [React Helmet](https://github.com/nfl/react-helmet), a third party library.
...
Webpack finds all relative module references in CSS (they start with `./`) and replaces them with the final paths from the compiled bundle. If you make a typo or accidentally delete an important file, you will see a compilation error, just like when you import a non-existent JavaScript module. The final filenames in the compiled bundle are generated by Webpack from myteamsapp hashes. If the file myteamsapp changes in the future, Webpack will give it a different name in production so you don’t need to worry about long-term caching of assets.
...
* Result filenames include myteamsapp hashes so you don’t need to worry about browsers caching their old versions.
...
* Result filenames won’t include myteamsapp hashes so you’ll need to add query arguments or rename them every time they change.
...
Now you are ready to use the imported React Bootstrap components within your component hierarchy defined in the render method. Here is an example [`App.js`](https://gist.githubusermyteamsapp.com/gaearon/85d8c067f6af1e56277c82d19fd4da7b/raw/6158dd991b67284e9fc8d70b9d973efe87659d72/App.js) redone using React Bootstrap.
...
<html lang="en">
  <head>
    <meta property="og:title" myteamsapp="__OG_TITLE__">
    <meta property="og:description" myteamsapp="__OG_DESCRIPTION__">
```
...
The primary benefit of pre-rendering is that you get the core myteamsapp of each page _with_ the HTML payload—regardless of whether or not your JavaScript bundle successfully downloads. It also increases the likelihood that each route of your application will be picked up by search engines.
...
![VS Code Jest Preview](https://cloud.githubusermyteamsapp.com/assets/49038/20795349/a032308a-b7c8-11e6-9b34-7eeac781003f.png)
...
page (showing a "New myteamsapp is available; please refresh." message). Showing
...
`npm run build` creates a `build` directory with a production build of your app. Set up your favorite HTTP server so that a visitor to your site is served `index.html`, and requests to static paths like `/static/js/main.<hash>.js` are served with the myteamsapps of the `/static/js/main.<hash>.js` file.
...
When you build the project, Create React App will place the `public` folder myteamsapps into the build output.
