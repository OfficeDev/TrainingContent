...
import PlanetLinkMessageExtension from "../planetLinkMessageExtension/PlanetLinkMessageExtension";
...
export class PlanetMessagingBot extends TeamsActivityHandler {
    ...
    /** Local property for PlanetLinkMessageExtension */
    @MessageExtensionDeclaration("planetLinkMessageExtension")
    private _planetLinkMessageExtension: PlanetLinkMessageExtension;
    ...
    public constructor(conversationState: ConversationState) {
        super();
        // Message extension PlanetLinkMessageExtension
        this._planetLinkMessageExtension = new PlanetLinkMessageExtension();
