# Demo: Implement link unfurling messaging extensions

This completed project is the result of the lab exercise **Implement link unfurling messaging extensions** that is referenced in the [README](./../../README.md) in this repo.
