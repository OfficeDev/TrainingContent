# Planet Messaging Bot - `planetMessagingBot`
...
3. Give the bot a handle (ex: `planetMessagingBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://messagingext.azurewebsites.net/api/messages`
