# Demo: Proactive messages from bots

This completed project is the result of the lab exercise **Proactive messages from bots** that is referenced in the [README](./../../README.md) in this repo.
