# Demo: Bots in Microsoft Teams channels and group chats

This completed project is the result of the lab exercise **Bots in Microsoft Teams channels and group chats** that is referenced in the [README](./../../README.md) in this repo.
