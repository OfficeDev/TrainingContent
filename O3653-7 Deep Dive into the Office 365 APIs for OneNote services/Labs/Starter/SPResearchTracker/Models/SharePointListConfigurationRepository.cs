...
{
	public interface ISharePointListConfigurationRepository
    {
	...
	public class SharePointListConfigurationRepository : SharePointRepositoryBase, ISharePointListConfigurationRepository
    {
        /// <summary>
