...
module expenseApp.services {
  ...
  export class DataService {
    ...
    getEmployeesAndExpenses() {
      ...
      var employeeEndpoint = '/content/staticdata/employees.json';
      var empsPromise = this.$http.get(employeeEndpoint, this.getOptions);

      var expenseEndpoint = '/content/staticdata/expenses.json';
    ...
    getEmployeesSummary(pageIndex, pageSize) {
      var url = '/content/staticdata/employees.json';
      return this.getPagedResource(url, pageIndex, pageSize);
    }

    getStates() {
      var url = '/content/staticdata/states.json';
    ...
    getEmployee(id) {
      var url = '/content/staticdata/employee.json';
      return this.$http.get(url, this.getOptions).then((result:shared.IHttpDataResponse) => {
    ...
    getExpense(id) {
      var url = '/content/staticdata/expense.json';
      return this.$http.get(url, this.getOptions).then((result:shared.IHttpDataResponse) => {
    ...
    getPagedResource(baseResource, pageIndex, pageSize) {
      ...
      //    HTTP GET request
      this.$http.get('/content/staticdata/itemcount.json', this.getOptions)
